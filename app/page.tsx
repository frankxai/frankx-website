...
const heroStats = [
  ...
  },
  {
    ...
    value: '500',
    detail: 'Transformational tracks produced with human + AI co-creation.'
  },
  {
...
const testimonials = [
  ...
  {
    quote:
      'Our Oracle team finally has language and rituals for building AI that honours people. The Soul Frequency work has become part of onboarding.',
    name: 'David Lin',
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main>
        ...
        <section className="relative overflow-hidden pt-32 pb-28">
          <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-indigo-900 to-blue-700" />
          <div
            className="absolute inset-0 opacity-60"
            style={{
              backgroundImage:
                'radial-gradient(circle at 20% 20%, rgba(255,255,255,0.15), transparent 55%), radial-gradient(circle at 80% 10%, rgba(255,255,255,0.12), transparent 45%), radial-gradient(circle at 50% 80%, rgba(255,63,152,0.18), transparent 50%)'
            }}
          />
          <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-[1.1fr,0.9fr] gap-16 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }}>
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-sm font-medium">
                <Sparkles className="w-4 h-4" /> Conscious AI Systems for Humans Who Lead with Heart
              </span>
              ...
              <p className="mt-5 text-lg text-slate-200/80 leading-relaxed max-w-xl">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <Link
                  href="/soul-frequency-assessment"
                  className="inline-flex items-center justify-center px-8 py-4 rounded-xl bg-white text-slate-900 font-semibold shadow-lg hover:shadow-xl transition"
                >
                ...
                <Link
                  href="/blog/intelligence-revolution-2025"
                  className="inline-flex items-center justify-center px-8 py-4 rounded-xl border border-white/40 text-white hover:bg-white/10 transition"
                >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="mt-4 text-slate-300">
                Whether you are designing enterprise platforms, guiding families, scaling a creative studio, or launching a new brand, we build a system that honours your people.
              </p>
            </motion.div>
        ...
        <section className="py-20 px-6 bg-gradient-to-b from-slate-950 to-slate-900">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {pillars.map((pillar) => (
                <div key={pillar.title} className="rounded-2xl p-8 text-white border border-white/10" style={{ backgroundImage: pillar.gradient }}>
                  <pillar.icon className="w-9 h-9 mb-5" />
                  <h3 className="text-2xl font-semibold mb-3">{pillar.title}</h3>
                  <p className="text-sm text-slate-100/85 leading-relaxed">{pillar.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-300 mt-3">
                Pick the door that resonates today. Each experience feeds the intelligence operating system we will build together.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {resources.map((resource, index) => (
                ...
                >
                  ...
                  <Link href={resource.href} className="inline-flex items-center gap-2 text-sm font-semibold text-white/80 hover:text-white mt-6">
                    Explore
                    <ArrowRight className="w-4 h-4" />
                  </Link>
                </motion.div>
